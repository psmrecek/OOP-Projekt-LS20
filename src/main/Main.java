...
//  			mojiPacienti.add(new Pacient("Dorota Chripkova", "Osloboditelov 4 Trencin", "025204/5464", 'Z', "d", "d"));
//  			mojiPacienti.add(new Pacient("Emilia Chripkova", "Osloboditelov 4 Trencin", "965608/5076", 'Z', "d", "d"));
//  			mojiPacienti.add(new Pacient("Frederika Chripkova", "Osloboditelov 4 Trencin", "935201/1922", 'Z', "d", "d"));
//  			mojiPacienti.add(new Pacient("Gertruda Soplikova", "Osloboditelov 5 Trencin", "985825/4274", 'Z', "d", "d"));
//  			mojiPacienti.add(new Pacient("Hyacinta Soplikova", "Osloboditelov 5 Trencin", "976121/8544", 'Z', "d", "d"));
//  			mojiPacienti.add(new Pacient("Ilona Soplikova", "Osloboditelov 5 Trencin", "026023/1257", 'Z', "d", "d"));
//  			mojiPacienti.add(new Pacient("Jan Poloslepy", "Osloboditelov 6 Trencin", "970523/0678", 'M', "d", "d"));
//  			mojiPacienti.add(new Pacient("Kristian Poloslepy", "Osloboditelov 6 Trencin", "021222/9930", 'M', "d", "d"));
//  			mojiPacienti.add(new Pacient("Ladislav Poloslepy", "Osloboditelov 6 Trencin", "930618/6461", 'M', "d", "d"));
//  		volniPacienti.add();
